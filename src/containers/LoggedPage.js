...
export const LoggedPage = () => {
  ...
  const [gifts, setGifts] = useState({
    ...
    giftId: 1,
    Gift:'',
    GiftImg: 'https://images.unsplash.com/photo-1573376670774-4427757f7963?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80',
    Quantity: 1,
    Sponsor: '',
    SponsorImg: '',
    giftItem: {},
    giftItems: [
      {
        Id: 1,
        Gift:'Batman lego',
        GiftImg: 'https://images.unsplash.com/photo-1542410613-d073472c3135?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60',
        Quantity: 1,
      ...
      {
        Id: 2,
        Gift:'Mini cruiser vermelho',
        GiftImg: 'https://images.unsplash.com/photo-1531565637446-32307b194362?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1826&q=80',
        Quantity: 1,
        Sponsor: 'WomakersCode',
        SponsorImg: 'https://miro.medium.com/max/478/1*jriufqYKgJTW4DKrBizU5w.png',
      },
      {
        Id: 3,
        Gift:'Game boy color',
        GiftImg: 'https://images.unsplash.com/photo-1531525645387-7f14be1bdbbd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1400&q=80',
        Quantity: 1,
        Sponsor: 'WomakersCode',
        SponsorImg: 'https://miro.medium.com/max/478/1*jriufqYKgJTW4DKrBizU5w.png',
      },
